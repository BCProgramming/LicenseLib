...
namespace BASeCamp.Licensing
{
    ...
    public class BASeCampLicenseKey : LicenseKeyData
    {
        /// <summary>
        ...
        {
            [Description("BASeCamp JobClock")] BCJobClock = 0,
            [Description("BASeCamp BASeBlock")] BASeBlock = 21
        }
        ...
        public byte _FeatureTrialBits;

        public byte FeatureTrialBits
        {
            get { return _FeatureTrialBits; }
            set { _FeatureTrialBits = value; }
        }
